...
const Locator: Template<TemplateRenderProps> = ({
  ...
  const Cuponcard = _site.c_banner?.map((i: any) => (
    <img src={i.url} className="card-img-top rounded-lg w-full" alt="..." style={{ height: "350px" }} />
  ));
        ...
        <AnalyticsScopeProvider name={""}>
          <PageLayout _site={_site}>
            ...
            <div className="flex space-x-24 pt-6" style={{ backgroundColor: "lightblue" }}>
              <div className="w-full">{Cuponcard}</div>
              {/* <div>{Cuponcard1}</div>
          <div>{Cuponcard2}</div> */}
            </div>
            {/* <Banner /> */}
